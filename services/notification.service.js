...
import NotificationHandler from '../tools/notificationHandler';
...
class NotificationService {
  ...
  localNotif({soundName, ticker,bigPictureUrl, largeIcon,largeIconUrl, bigText, subText, actions, title, message, userInfo={}}) {
    this.lastId++;
